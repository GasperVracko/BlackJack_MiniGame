package si.um.feri.vracko.assets;
...
public class AssetDescriptors {
    ...
    public static final AssetDescriptor<Sound> CHIP_SOUND =
            new AssetDescriptor<Sound>(AssetPaths.CHIP_SOUND, Sound.class);
    public static final AssetDescriptor<Sound> DRAW_CARD_SOUND =
            new AssetDescriptor<Sound>(AssetPaths.DRAW_CARD_SOUND, Sound.class);
